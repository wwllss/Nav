...
class RegisterTransform extends Transform {
    ...
    static Map<ScanSetting, File> fileContainsInitClass = [:]
    ...
    void transform(Context context, Collection<TransformInput> inputs
        ...
        if (!fileContainsInitClass.isEmpty()) {
            registerList.each { ext ->
                if (fileContainsInitClass[ext] != null) {
                    Logger.i('Insert register code to file ' + fileContainsInitClass[ext].absolutePath)
